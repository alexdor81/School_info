...
Web-приложение на языке Python с использованием Django, PostgreSQL, Docker. Поддерживаeт осуществление CRUD-операций, импорт/экспорт таблиц, выполнение операций/функций через графический интерфейс, SQL-запросов, а также логирование действий пользователя.
